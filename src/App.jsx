        ...
        <div className="card">
          ...
          <div className="question-area">
            <div className="question enter">
              ...
              <div
                className="amharic"
                style={{ fontSize: 13, marginTop: 8, color: "#56606a" }}
              >
            ...
            {q.type === "freq" && (
              <div>
                <div style={{ marginBottom: 10 }}>
                  {q.globalOptions &&
                    q.globalOptions.map((g) => (
                      <button
                        key={g}
                        className="option-button"
                        style={{ marginRight: 8 }}
                        onClick={() => {
                          setAnswer("freq", { period: "none", value: g });
                          setI((s) => s + 1);
                        }}
                      >
                        {g}
                  ...
                  {q.groups.map((gr) => (
                    <div key={gr.id} className="freq-group">
                      <div
                        ...
                        onClick={() =>
                          setExpandedFreqGroup((cur) =>
                            cur === gr.id ? null : gr.id,
                          )
                        }
                      >
                        <div>
                        ...
                        <div
                          className={`chev ${expandedFreqGroup === gr.id ? "expanded" : ""}`}
                        >
                          ›
                        </div>
                      </div>
    ...
    <div>
      ...
      {sel.has("Other (please specify) — ሌላ (ይጻፉ)") && (
        <input
          ...
          onChange={(e) =>
            onChange([
              ...Array.from(sel).filter((x) => !x.includes("Other")),
              e.target.value,
            ])
          }
        />
