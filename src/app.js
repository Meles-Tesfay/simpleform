const app = (() => {
  ...
  function render() {
    ...
    if (item.type === "composite") {
      ...
      slider.addEventListener("input", () => {
        answers["spend_slider"] = slider.value;
        sliderLabel.textContent = `~ ${slider.value} ETB per visit (optional)`;
      });
      ...
      weekly.addEventListener(
        "input",
        () => (answers["weekly_total"] = weekly.value),
      );
    ...
    if (item.type === "business") {
      ...
      input.addEventListener("input", () => {
        answers["business_name"] = input.value;
      });
      ...
      fLabel.className = "small-note";
      fLabel.textContent = "How often do you go there?";
      follow
        .appendChild(fLabel)
    ...
    if (item.type === "multi") {
      ...
      otherInput.addEventListener(
        "input",
        () => (answers["where_other"] = otherInput.value),
      );
  ...
  function showFinal() {
    ...
    wrap.className = "question enter";
    const h = document.createElement("h2");
    h.textContent = "🎉 You're done! Thanks for helping improve student life.";
    const am = document.createElement("div");
    am.className = "amharic";
    am.textContent = "እስራሕ! አመሰግናለን — ለተማሪዎ ሕይወት ለማሻሻል ተማሪ ግምገማዎ ጠቃሚ ነው።";
    const note = document.createElement("div");
    note.className = "small-note";
    note.textContent = "We use this data to bring better student discounts 👀";
    wrap.appendChild(h);
    wrap.appendChild(am);
    wrap.appendChild(note);
    ...
    debug.textContent = JSON.stringify(answers, null, 2);
  ...
  function intro() {
    ...
    w.className = "question enter";
    const h = document.createElement("h2");
    h.textContent = "Takes only 30 seconds ⏱";
    const am = document.createElement("div");
    am.className = "amharic";
    am.textContent = "ብዙ ጊዜ አይወስድም — የ30 ሰከንድ ጥያቄዎች";
    const p = document.createElement("div");
    p.className = "small-note";
    p.textContent = "Almost done 👀 — quick and anonymous.";
    const start = document.createElement("button");
    start.className = "btn primary";
    start.style.marginTop = "16px";
    start.textContent = "Start Survey";
